...
# FUNCTIONS
    * printGrid(grid) 
        - printGrid(grid) takes in grid[GRID_HEIGHT][GRID_WIDTH], most likely playerGrid[GRID_HEIGHT][GRID_WIDTH] as input and prints it out in the terminal with corresponding borders and coordinate labels.
